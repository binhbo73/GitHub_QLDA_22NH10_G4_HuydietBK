...
export default function ChatbotPage({ params }: ChatbotPageProps) {
  ...
  const data = chatbotData[params.type as keyof typeof chatbotData]
        ...
        <div className="grid grid-cols-4 gap-4 w-full max-w-4xl">
          <Link
            ...
            className={`text-center px-4 py-3 rounded-full transition-colors ${
              params.type === "general" ? "bg-white text-purple-900" : "bg-purple-900/20 hover:bg-purple-900/40"
            }`}
          >
          ...
          <Link
            href="/chatbot/sales"
            className={`text-center px-4 py-3 rounded-full transition-colors ${
              params.type === "sales" ? "bg-white text-purple-900" : "bg-purple-900/20 hover:bg-purple-900/40"
            }`}
          >
            Sale Copy Writer AI
          </Link>
          <Link
            ...
            className={`text-center px-4 py-3 rounded-full transition-colors ${
              params.type === "negotiation" ? "bg-white text-purple-900" : "bg-purple-900/20 hover:bg-purple-900/40"
            }`}
          >
          ...
          <Link
            ...
            className={`text-center px-4 py-3 rounded-full transition-colors ${
              params.type === "marketing" ? "bg-white text-purple-900" : "bg-purple-900/20 hover:bg-purple-900/40"
            }`}
          >
