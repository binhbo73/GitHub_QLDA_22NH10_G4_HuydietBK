...
from .views import QAView, ChatSessionIdAPIView, ChatSessionAPIView, QAPairsAPIView, SpeechToTextAPIView, TextToSpeechAPIView
...
urlpatterns = [
    ...
    path('sst/', view=SpeechToTextAPIView.as_view(), name='speech-to-text-view'),
    path('tts/', view=TextToSpeechAPIView.as_view(), name='text-to-speech-view'),
]
